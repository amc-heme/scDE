...
`NAMESPACE` and all `man/*.Rd` are generated by roxygen2 (`RoxygenNote: 7.3.3`). Always run `devtools::document()` after changing any `@` tags. Manual edits will be overwritten.
