...
#'
#' @description
#' An AML single cell reference dataset produced by \href{https://doi.org/10.1038/s41590-021-01059-0}{Triana et al. 2021}. This is a small subset of the original  data that is intended for package testing, as well as demonstration of key functionality.
#'
#' @description
